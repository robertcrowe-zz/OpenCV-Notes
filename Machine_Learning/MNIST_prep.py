"""
Segmenting and Prepping for MNIST

TODO - Lots of cleanup. This code is a bit of a mess.

This code does an MNIST-like classification, but the interesting part
is really in the segmentation and prep of the image.  It's using contours
to create bounding boxes around digits on a fairly simple background. 
With a complex background this by itself would not work. 
"""
import numpy as np
import cv2
import os.path
...
image = cv2.imread(dirname + 'images/digits.png')
...
image = cv2.imread(dirname + 'images/numbers.jpg')
gray = cv2.cvtColor(image,cv2.COLOR_BGR2GRAY)
