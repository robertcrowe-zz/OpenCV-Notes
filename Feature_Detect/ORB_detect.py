...
def ORB_detector(new_image, image_template):
    ...
    Returns (int): the number of ORB matches between them
    """
    ...
    # Detect keypoints of webcam image
    (kp1, des1) = orb.detectAndCompute(image1, None)

    # Detect keypoints of object image that we're looking for
...
# image_template = cv2.imread(os.path.dirname(__file__) + '/../images/kitkat.jpg', 0) 
